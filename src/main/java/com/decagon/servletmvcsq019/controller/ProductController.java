...
import com.decagon.servletmvcsq019.model.Cart;
import com.decagon.servletmvcsq019.model.Order;
import com.decagon.servletmvcsq019.model.Product;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (payment!=null&&paymentCart!=null){
            ...
            paymentCart.getProductIds().forEach(id->{
                ...
                Product product = productDao.findProductsById.apply(id);
        ...
        if(editProduct!=null){
            Product product =  productDao.findProductsById.apply(Long.parseLong(editProduct));
